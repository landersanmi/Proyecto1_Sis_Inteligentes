...
# This command can give an error if "non-ASCII" characters are in the route.
...
# Define and assign values to variable
a <- 2
b <- "two"
a <- "Three"
b <- 3.4
...
vec_3 <- runif(10, 50, 100) # 10 random decimal numbers between 50 and 100
...
# Retuns the correlative index starting at position [1,1], [1,2], [1,3] ...
